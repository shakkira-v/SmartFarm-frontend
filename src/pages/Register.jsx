      ...
      <div className="relative z-10 w-full max-w-md animate-in fade-in zoom-in duration-500">
        <div className="bg-white/95 backdrop-blur-2xl rounded-[2.5rem] p-8 md:p-12 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.3)] border border-white/20">
          ...
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl font-black text-slate-800 tracking-tight">Recruitment</h2>
            <p className="text-slate-500 text-sm mt-2 font-medium">Join the Smart Farm Security team today.</p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-slate-800 focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-600 outline-none transition-all font-medium"
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <select
                  ...
                  className="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-slate-800 focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-600 outline-none transition-all font-medium appearance-none"
                >
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-4 bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-400 text-white rounded-2xl font-black text-lg shadow-xl shadow-emerald-500/20 transition-all active:scale-[0.98] flex items-center justify-center gap-2 mt-4"
            >
              {isLoading ? (
                <div className="w-6 h-6 border-2 border-white/30 border-t-white rounded-full animate-spin" />
              ) : (
                <>
                  Submit Application <UserPlus size={20} />
                </>
              )}
            </button>
          </form>
          ...
          <p className="text-center mt-10 text-sm text-slate-400 font-medium">
            Already registered? <Link to="/login" className="text-emerald-600 font-bold hover:underline">Sign into grid</Link>
          </p>
        </div>
